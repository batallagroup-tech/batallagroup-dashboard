    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '64px 48px 48px' }}>
        <div style={{ marginBottom: 12 }}>
          <span style={{
            fontSize: 10, letterSpacing: '0.4em', color: '#1e1e2e',
        ...
        <h2 style={{
          ...
          margin: '0 0 4px', letterSpacing: '2px', lineHeight: 1,
        }}>
          APLICACIONES
        </h2>
        <h2 style={{
          color: 'rgba(255,255,255,0.15)', fontSize: 42, fontWeight: 900,
          margin: '0 0 48px', letterSpacing: '2px', lineHeight: 1,
        }}>
          CONECTADAS
        </h2>
          ...
          {APPS.map(app => (
            ...
            >
              ...
              <div style={{
                ...
                background: app.topLine, opacity: 0.5,
              }} />
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
                <div style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
                  ...
                  <div>
                    <h3 style={{ color: '#e0e0f0', fontSize: 17, fontWeight: 900, margin: '0 0 6px', letterSpacing: '0.5px' }}>
                      {app.name}
                    </h3>
      ...
      <div style={{
        position: 'relative', zIndex: 1,
        borderTop: '1px solid #0d0d16',
        padding: '16px 48px',
        display: 'flex', justifyContent: 'space-between', alignItems: 'center',
        marginTop: 40,
      }}>
        <span style={{ color: '#141420', fontSize: 10, letterSpacing: '0.2em' }}>
          © 2026 BATALLAGROUP
        </span>
        <span style={{ color: '#141420', fontSize: 10, letterSpacing: '0.2em' }}>
          V 1.4.0
